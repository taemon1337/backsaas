...
func ValidateEmail(ctx context.Context, execCtx *types.ExecutionContext, email string, allowedDomains []string) (bool, error) {
...
func ValidatePassword(ctx context.Context, execCtx *types.ExecutionContext, password string, minLength int, requireUppercase, requireNumbers, requireSymbols bool) (bool, error) {
...
func ValidatePhone(ctx context.Context, execCtx *types.ExecutionContext, phone, countryCode string) (bool, error) {
